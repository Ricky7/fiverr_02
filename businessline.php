    ...
    <div class="col-md-12">
      <div class="panel panel">
        <div class="panel-heading" style="background:#34495e;">
          <h3 class="panel-title" style="color:#fff;">Business Line</h3>
        </div>
    ...
    <form method="post" id="user_form" enctype="multipart/form-data">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add BusinessLine</h4>
        </div>
        ...
        <div class="modal-footer">
          ...
          <input type="hidden" name="table" id="table" value="businessline"/>
...
$(document).ready(function(){
  ...
  $('#add_button').click(function(){
    $('#user_form')[0].reset();
    $('.modal-title').text("Add BusinessLine");
    $('#action').val("Add");
    $('#operation').val("Add");
  });
  var op_id = 'businessline';
  ...
  $(document).on('click', '.update', function(){
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        $('.modal-title').text("Edit BusinessLine");
        $('#x_id').val(x_id);
        $('#action').val("Edit");
        $('#operation').val("Edit");
      }
